...
CREATE INDEX `fk_city_region1_idx` ON `bakalik_db`.`city` (`region_region` ASC) VISIBLE;
...
CREATE INDEX `fk_item_category1_idx` ON `bakalik_db`.`item` (`category_id` ASC) VISIBLE;
...
CREATE INDEX `fk_item_review_item1_idx` ON `bakalik_db`.`item_review` (`item_id` ASC) VISIBLE;
...
INSERT INTO `city`
VALUES (1, 'Львів', 'Львівська область');
INSERT INTO `city`
VALUES (2, 'Київ', 'Київська область');
INSERT INTO `city`
VALUES (3, 'Дрогобич', 'Львівська область');
INSERT INTO `city`
VALUES (4, 'Пустомити', 'Львівська область');
INSERT INTO `city`
VALUES (5, 'Трускавець', 'Львівська область');
INSERT INTO `city`
VALUES (6, 'Шацьк', 'Волинська область');
INSERT INTO `city`
VALUES (7, 'Люблинець', 'Волинська область');
INSERT INTO `city`
VALUES (8, 'Болехів', 'Івано-Франківська область');
INSERT INTO `city`
VALUES (9, 'Надвірна', 'Івано-Франківська область');
INSERT INTO `city`
VALUES (10, 'Яремче', 'Івано-Франківська область');
...
INSERT INTO `item`
VALUES (1, 'Навушники', 2, 'Безпровідні навушники', 'картинка', 'Xiaomi', 'AirDots', '-', 600);
INSERT INTO `item`
VALUES (2, 'Смартфон', 2, 'Смартфон Iphone 13', 'картинка', 'Iphone', '13', '-', 40000);
INSERT INTO `item`
VALUES (3, 'Ноутбук', 1, 'Геймерський ноутбук', 'картинка', 'Asus', 'Rog Strix G', '-', 27000);
INSERT INTO `item`
VALUES (4, 'Віскі', 9, 'Віскі WIlliam Lawson\'s 3 роки 0.5 л 40%', 'картинка', 'WIlliam Lawson\'s', '-', '-', 190);
INSERT INTO `item`
VALUES (5, 'Шліфмашина', 5, 'Ексцентрикова шліфмашина Intertool', 'картинка', 'Intertool Storm', 'WT-0541', '-', 625);
INSERT INTO `item`
VALUES (6, 'Подушка', 4, 'Набір подушок Sleepingg 50х70 2 шт.', 'картинка', 'Sleepingg ', '50х70', '-', 240);
INSERT INTO `item`
VALUES (7, 'Ванна', 6, 'ANTHEUS Duo Ванная кварил', 'картинка', 'ANTHEUS ', '1750x800', 'Duo', 184844);
INSERT INTO `item`
VALUES (8, 'Кросівки', 10, 'Кросівки Puma Wild Rider', 'картинка', 'Puma', 'Wild Rider', '-', 3200);

INSERT INTO `item_review`
VALUES (2, 1, 'Андрій Беляк', 5, '2020-02-01 00:00:00', 'Вдруге купую ці навушники. Якість відмінна!');
INSERT INTO `item_review`
VALUES (3, 1, 'Сергей Избаш', 4, '2021-08-04 00:00:00', 'Якість відмінна!');
INSERT INTO `item_review`
VALUES (4, 2, 'Себастьян Перейро', 4, '2021-03-06 12:05:34',
        'Придбали на заміну iPhone SE (1st). Все чудово! Доставка Rozetka як завжди на висоті!');
INSERT INTO `item_review`
VALUES (5, 2, 'Євген Кульчицький', 4, '2021-03-02 21:01:32', 'Все чудово!');
INSERT INTO `item_review`
VALUES (6, 4, 'Артем', 4, '2021-01-06 12:05:34', 'Класс!');
INSERT INTO `item_review`
VALUES (7, 5, 'Олег Александрович', 5, '2021-09-01 16:05:19', 'Доставили вчасно)');
INSERT INTO `item_review`
VALUES (8, 5, 'Юрий Титов', 5, '2021-07-11 22:15:34', 'Відмінно!');
INSERT INTO `item_review`
VALUES (9, 7, 'Роман', 5, '2021-02-10 04:24:12', 'Все сподобалось)');
INSERT INTO `item_review`
VALUES (10, 8, 'Артем Деркач', 4, '2021-03-06 21:57:56', 'Доставка на висоті)');
...
VALUES ('Завершено');
INSERT INTO `order_status`
VALUES ('Комплектується');
INSERT INTO `order_status`
VALUES ('Очікує оплати');
INSERT INTO `order_status`
VALUES ('Повернення платежу');
INSERT INTO `order_status`
VALUES ('Тимчасово затриманий');
...
VALUES (2, 'Максим', 'Максим', '2020-03-01', 1, 1, 'вул. Шевченка', '79007', '0992233441', 'maksym@gmail.com',
        '2020-02-01 00:00:00', '2020-02-01 10:00:00', 1);
INSERT INTO `user`
VALUES (3, 'Олег', 'Петруняк', '2000-09-02', 1, 1, 'вул. Кульпарківська', '79068', '0995576121', 'oleg@gmail.com',
        '2019-10-11 12:34:23', '2020-09-11 11:14:59', 1);
INSERT INTO `user`
VALUES (4, 'Ольга', 'Войневич', '1980-09-02', 2, 3, 'вул. Шевченка 11/12', '00101', '0971274221', 'olga@gmail.com',
        '2019-10-11 11:47:32', '2020-10-11 12:34:43', 2);
INSERT INTO `user`
VALUES (5, 'Тарас', 'Терещук', '1979-10-11', 1, 7, 'вул. Франка 9/12', '12322', '0961345324', 'Taras@gmail.com',
        '2018-01-13 15:24:33', '2018-01-13 15:24:33', 2);
INSERT INTO `user`
VALUES (6, 'Макс', 'Боженко', '1980-12-12', 1, 6, 'вул. Лесі Українки 24/56', '54677', '0971456574', 'max@gmail.com',
        '2019-10-11 21:36:41', '2020-10-11 20:36:41', 2);
INSERT INTO `user`
VALUES (7, 'Саша', 'Семеніхін', '1960-10-24', 3, 5, 'вул. Герїв УПА 01/98', '23334', '0971546457', 'sasha@gmail.com',
        '2017-01-12 11:54:12', '2017-11-12 13:54:12', 3);
INSERT INTO `user`
VALUES (8, 'Віка', 'Скороход', '1975-05-12', 2, 1, 'вул. Городоцька 34/78', '82334', '0971289734', 'vika@mail.ru',
        '2019-10-11 18:41:13', '2019-11-11 13:41:13', 1);
INSERT INTO `user`
VALUES (9, 'Назар', 'Галайчук', '1997-01-27', 1, 3, 'вул. Шевченка 12/102', '65444', '0971735671', 'nazar@gmail.com',
        '2020-06-01 16:32:56', '2021-07-03 15:46:43', 1);
INSERT INTO `user`
VALUES (10, 'Олександр', 'Терещук', '1954-03-02', 1, 3, 'вул. Шевченка 11/12', '23111', '0989346341',
        'oleksandr@gmail.com', '2019-07-03 15:46:43', '2019-07-03 15:46:43', 4);

INSERT INTO `order`
VALUES (1, 2, '2020-02-01 00:00:00', 1, 2, 1000, 'Завершено');
INSERT INTO `order`
VALUES (2, 2, '2021-08-21 14:54:23', 1, 2, 230, 'В очікуванні');
INSERT INTO `order`
VALUES (3, 2, '2020-10-11 13:23:11', 1, 2, 2300, 'Відправлений');
INSERT INTO `order`
VALUES (4, 3, '2020-11-03 23:32:10', 1, 3, 32000, 'Завершено');
INSERT INTO `order`
VALUES (5, 4, '2020-06-01 10:45:23', 3, 7, 1890, 'Відправлений');
INSERT INTO `order`
VALUES (6, 5, '2020-02-01 13:44:23', 7, 3, 2346, 'Комплектується');
INSERT INTO `order`
VALUES (7, 5, '2020-09-23 23:56:51', 7, 7, 2300, 'Очікує оплати');
INSERT INTO `order`
VALUES (8, 6, '2020-12-21 10:12:56', 6, 4, 5400, 'В очікуванні');
INSERT INTO `order`
VALUES (9, 8, '2020-02-01 01:10:34', 1, 3, 420, 'Відправлений');
...
VALUES (1, 'Аксесуари для ноутбуків і ПК');
INSERT INTO `sub_category`
VALUES (1, 'Комплектуючi');
INSERT INTO `sub_category`
VALUES (1, 'Ноутбуки');
INSERT INTO `sub_category`
VALUES (2, 'Аксесуари до мобільних телефонів');
INSERT INTO `sub_category`
VALUES (2, 'Телевізори та аксесуари');
INSERT INTO `sub_category`
VALUES (4, 'Інвентар для дому та офісу');
INSERT INTO `sub_category`
VALUES (5, 'Витратні матеріали та приладдя');
INSERT INTO `sub_category`
VALUES (5, 'Електромонтажне обладнання');
INSERT INTO `sub_category`
VALUES (7, 'Системи поливання');
INSERT INTO `sub_category`
VALUES (9, 'Продукти');
